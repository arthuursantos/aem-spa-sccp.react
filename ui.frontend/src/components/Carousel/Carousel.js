...
const Carousel = (props) => {
    ...
    if (contentType === "player") {
        assets = props.playerAssets || [];
        players = sliceArray(assets, 3)
    } else if (contentType === "news") {
        assets = props.newsAssets || [];
    }
                ...
                <div id="newsCarousel" className="carousel slide" data-bs-ride="carousel">
                    <div className="carousel-inner">
                        {assets.map((asset, index) => {
                            let newsId;
                            if (asset.fragmentPath) {
                                newsId = asset.fragmentPath.split("/").pop();
                            }
                            return (
                                <div key={index} className={`carousel-item ${index === 0 ? "active" : ""}`}>
                                    <a href={`http://localhost:4502/content/aem-spa-sccp/noticias.html?wcmmode=disabled&id=${newsId}`}>
                                        <img
                                    ...
                                    <div
                                        className="carousel-caption d-none d-md-block position-static bg-black text-start start-0 w-100">
                ...
                <div id="playerCarousel" className="carousel slide bg-black p-5 d-flex flex-column align-items-center">
                    <div className="d-flex gap-4 align-items-center justify-content-center pb-4">
                        ...
                        <div className="d-flex gap-1 align-items-center">
                            <button className="border-0 bg-black text-white fw-bolder" type="button"
                                    data-bs-target="#playerCarousel" data-bs-slide="prev">
                                <ChevronLeft strokeWidth={3}/>
                            </button>
                            <span className="fs-5">|</span>
                            <button className="border-0 bg-black text-white fw-bolder" type="button"
                                    data-bs-target="#playerCarousel" data-bs-slide="next">
                                            ...
                                            <div className="bg-gradient d-flex flex-row align-items-center gap-3 p-3">
                                                ...
                                                <div className="d-flex flex-column gap-2 text-white">
                                                    <div>
                                                        ...
                                                        <span
                                                            className="playerPosition text-uppercase text-white-50">{player.position}</span>
                                                    </div>
